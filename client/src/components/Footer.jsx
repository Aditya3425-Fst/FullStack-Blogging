    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <h3>MyBlog</h3>
          <p>Publish your passions, your way. Create a unique and beautiful blog easily.</p>
        ...
        <div className="footer-section">
          ...
          <div className="footer-links">
            ...
            <Link to="/signup">Create your blog</Link>
          </div>
        </div>
        ...
        <div className="footer-section">
          ...
          <div className="footer-links">
            ...
            <Link to="/blogs?category=food">Food & Cooking</Link>
            <Link to="/blogs?category=health">Health & Fitness</Link>
          </div>
        </div>
